...
function toFailure(
  index: number,
  notice: { Code: number; Message?: string; Details?: string },
): FailedOperation {
        ...
        log.warn(
          {
            ...
            code: err.Code,
            message: err.Message,
            behaviour: classifyErrorCode(err.Code),
          },
...
function pickResults(result: Record<string, unknown>): ActionResult[] | undefined {
  for (const key of [
    'UpdateResults',
    'SetResults',
    'SuspendResults',
