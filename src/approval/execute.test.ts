...
/**
 * Инвариант: вид действия, объявленный в схеме, обязан иметь исполнителя.
 *
 * Это половина обещания — про вид действия. Вторая половина, про пару «вид действия
 * × канал», живёт в `src/approval/supported.test.ts` и гоняется против настоящих
 * адаптеров: здешний адаптер умеет всё, и про VK он не говорит ничего.
 *
