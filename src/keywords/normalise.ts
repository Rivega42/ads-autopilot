...
/**
 * Сколько букв обязано остаться после усечения.
 *
 * Порог был 4, и на нём проверка самоминусовки промахивалась на самых обычных
 * словах: «роза» и «розы» (как и «тур»/«туры», «окно»/«окна», «дом»/«дома»)
 * оказывались короче порога, оставались нетронутыми и давали разные основы. Для
 * Директа это одно слово — он минусует по лемме, — поэтому минус-слово «тур»
 * проходило проверку и выключало собственный ключ клиента «туры в турцию».
 *
 * Ниже трёх опускать нельзя: тогда «чай» превратился бы в «ча», и совпадать
 * начали бы уже разные слова. Трёхбуквенные корни с гласными окончаниями
 * («чай» / «чая») этой проверке по-прежнему не по зубам — усечение не морфология.
 */
