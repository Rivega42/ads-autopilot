...
describe('dedupePhrases', () => {
  ...
  it('представитель — самая короткая формулировка, при равенстве первая встреченная', () => {
    const result = dedupePhrases([
      'курсы английского онлайн',
      'онлайн курсы английского для взрослых',
      'английского курсы онлайн',
    ]);
    expect(result.groups[0]?.phrase).toBe('курсы английского онлайн');
  });

  it('детерминирован: тот же вход — тот же выход', () => {
    const input = ['курсы английского онлайн', 'онлайн курсы английского', 'английский с нуля'];
    expect(dedupePhrases(input)).toEqual(dedupePhrases(input));
  });
