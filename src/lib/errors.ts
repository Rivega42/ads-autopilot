...
export class OutOfUnitsError extends ChannelError {
  constructor(channel: Provider, retryAfterMs = 60 * 60 * 1000, context = {}) {
...
export class AuthError extends ChannelError {
  constructor(channel: Provider, message = 'Authentication failed', context = {}) {
...
export class RateLimitError extends ChannelError {
  constructor(channel: Provider, retryAfterMs: number, context = {}) {
